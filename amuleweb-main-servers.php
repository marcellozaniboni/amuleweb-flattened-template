...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top"> 
    ...
    <td width="100%" height="64" align="left" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td title="ed2k servers"><a href="amuleweb-main-servers.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('edkserver','','images/edkserv_1.png',1)"><img src="images/edkserv_1.png" alt="edkserver" name="edkserver" width="52" height="52" border="0"></a></td>
  ...
  <tr align="center" valign="top"> 
    <td colspan="2">
        ...
        <tr><td colspan="3" style="padding-left: 20px; padding-top: 28px"><b>SERVERS</b></td></tr>
          <tr> 
