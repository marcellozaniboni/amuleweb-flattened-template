...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top"> 
    ...
    <td width="100%" height="64" align="left" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td title="logs"><a href="amuleweb-main-log.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('logs','','images/logs_1.png',1)"><img src="images/logs_1.png" alt="logs" name="logs" width="52" height="52" border="0"></a></td>
  ...
  <tr align="center" valign="top"> 
    <td colspan="2">        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr><td colspan="3" style="padding-left: 20px; padding-top: 28px"><b>LOGS</b></td></tr>
          <tr> 
