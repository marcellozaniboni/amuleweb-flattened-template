...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top"> 
    <td width="100" height="64"><img src="images/logo.png" width="100" height="64"></td>
    <td width="100%" height="64" align="left" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td title="download and upload"><a href="amuleweb-main-dload.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('transfert','','images/transf_1.png',1)"><img src="images/transf_1.png" alt="transfert" name="transfert" width="52" height="52" border="0"></a></td>
          <td title="shared files"><a href="amuleweb-main-shared.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('shared','','images/shared_1.png',1)"><img src="images/shared_0.png" alt="shared" name="shared" width="52" height="52" border="0"></a></td>
          <td title="search"><a href="amuleweb-main-search.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('search','','images/search_1.png',1)"><img src="images/search_0.png" alt="search" name="search" width="52" height="52" border="0"></a></td>
          <td title="ed2k servers"><a href="amuleweb-main-servers.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('edkserver','','images/edkserv_1.png',1)"><img src="images/edkserv_0.png" alt="edkserver" name="edkserver" width="52" height="52" border="0"></a></td>
          <td title="kademlia"><a href="amuleweb-main-kad.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sheserv','','images/sheserv_1.png',1)"><img src="images/sheserv_0.png" alt="sheserv" name="sheserv" width="52" height="52" border="0"></a></td>
          <td title="statistics"><a href="amuleweb-main-stats.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('statistiques','','images/stats_1.png',1)"><img src="images/stats_0.png" alt="statistiques" name="statistiques" width="52" height="52" border="0"></a></td>
          <td title="logs"><a href="amuleweb-main-log.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('logs','','images/logs_1.png',1)"><img src="images/logs_0.png" alt="logs" name="logs" width="52" height="52" border="0"></a></td>
          <td title="configuration"><a href="amuleweb-main-prefs.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('settings','','images/settings_1.png',1)"><img src="images/settings_0.png" alt="settings" name="settings" width="52" height="52" border="0"></a></td>
          <td align="right" width="100%"><a href="login.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('logout','','images/logout_1.png',1)"><img title="exit" src="images/logout_0.png" alt="exit" name="logout" width="52" height="52" border="0"></a></td>
        </tr>
      </table></td>
  </tr>
  <tr align="center" valign="top">
    <td colspan="2" style="padding-top: 20px"><form action="amuleweb-main-dload.php" method="post" name="mainform">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
      <td align="left" style="padding-left: 20px"><table border="0" cellpadding="0" cellspacing="0">
          <tr> 
	    <td style="padding-right: 10px">File commands: </td>
            <td><input type="hidden" name="command"></td>
            <td title="pause"><a href="javascript:formCommandSubmit('pause');" onClick="MM_nbGroup('down','group1','pause','',1)" onMouseOver="MM_nbGroup('over','pause','','',1)" onMouseOut="MM_nbGroup('out')"><img name="pause" src="images/pause.png" alt="pause" border="0" onLoad=""></a></td>
            <td title="resume"><a href="javascript:formCommandSubmit('resume');" onClick="MM_nbGroup('down','group1','resume','',1)" onMouseOver="MM_nbGroup('over','resume','','',1)" onMouseOut="MM_nbGroup('out')"><img img name="resume" src="images/play.png" alt="resume" border="0" onLoad=""></a></td>
        		<td title="priority up"><a href="javascript:formCommandSubmit('prioup');" onClick="MM_nbGroup('down','group1','up','',1)" onMouseOver="MM_nbGroup('over','up','','',1)" onMouseOut="MM_nbGroup('out')"><img img name="prioup" src="images/up.png" alt="prioup" border="0" onLoad=""></a></td>
        		<td title="priority down"><a href="javascript:formCommandSubmit('priodown');" onClick="MM_nbGroup('down','group1','down','',1)" onMouseOver="MM_nbGroup('over','down','','',1)" onMouseOut="MM_nbGroup('out')"><img img name="priodown" src="images/down.png" alt="priodown" border="0" onLoad=""></a></td>
        		<td title="delete"><a href="javascript:formCommandSubmit('cancel');" onClick="MM_nbGroup('down','group1','cancel','',1)" onMouseOver="MM_nbGroup('over','delete','','',1)" onMouseOut="MM_nbGroup('out')"><img img name="cancel" src="images/close.png" alt="cancel" border="0" onLoad=""></a></td>
      <td><table border="0" cellpadding="0" cellspacing="0">
        ...
        ?>
                  			...
                  			<td title="apply filter"><a href="javascript:formCommandSubmit('filter');" onClick="MM_nbGroup('down','group1','resume','',1)" onMouseOver="MM_nbGroup('over','resume','','',1)" onMouseOut="MM_nbGroup('out')"><img src="images/filter.png" border="0" alt="Apply" name="resume" border="0" onload=""></a></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td> 
                    <?php
  ...
  <tr>
  	<td colspan="3" style="padding-left: 20px; padding-top: 10px"><b>DOWNLOADS</b></td>
  </tr>
  <tr>
