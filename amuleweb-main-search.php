...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign="top"> 
    ...
    <td width="100%" height="64" align="left" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td title="search"><a href="amuleweb-main-search.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('search','','images/search_1.png',1)"><img src="images/search_1.png" alt="search" name="search" width="52" height="52" border="0"></a></td>
  ...
  <tr align="center" valign="top"> 
    <td colspan="2">
        ...
        <tr><td colspan="3" style="padding-left: 20px; padding-top: 28px"><b>SEARCH</b></td></tr>
          <tr> 
	...
	<table width="100%">
		<tr>
			<td>
				...
				File name: <input name="searchval" type="text" id="searchval4" size="60"> 
				&nbsp;&nbsp;
				Availability: <input name="avail" type="text" id="avail13" size="6">
			</td>
		</tr>
		<tr>
			<td>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				Min Size: <input name="minsize" type="text" id="minsize2" size="5"> 
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				Max Size: <input name="maxsize" type="text" id="maxsize4" size="5"> 
		...
		<tr>
			<td>
				...
				&nbsp;
				<input name="Refresh" type="button" id="refresh" value="Refresh results" onclick="document.location.href='amuleweb-main-search.php';" title="Update the search results"/>
			</td>
		</tr>
		<tr>
			<td style="padding-top: 20px; padding-bottom: 20px"><hr style=" border: 0; height: 1px; background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));"/></td>
		</tr>
	</table>
